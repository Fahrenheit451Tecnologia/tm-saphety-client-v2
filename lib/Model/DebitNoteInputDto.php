 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DebitNoteInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DebitNoteInputDto';
    ...
    protected static $attributeMap = [
        ...
        'create_audit_event_type' => 'CreateAuditEventType',
    ...
    protected static $setters = [
        ...
        'create_audit_event_type' => 'setCreateAuditEventType',
    ...
    protected static $getters = [
        ...
        'create_audit_event_type' => 'getCreateAuditEventType',
    ...
    const CREATE_AUDIT_EVENT_TYPE_CREATE_SALES_INVOICE = 'CreateSalesInvoice';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_CREDIT_NOTE = 'CreateCreditNote';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_DEBIT_NOTE = 'CreateDebitNote';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_ASYNC = 'CreateDocumentAsync';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_ASYNC_GENERATE_UBL_DOCUMENT = 'CreateDocumentAsyncGenerateUblDocument';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_ASYNC_SEND_TO_AUTHORIZED_PROVIDER = 'CreateDocumentAsyncSendToAuthorizedProvider';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_SERIE = 'CreateSerie';
    const CREATE_AUDIT_EVENT_TYPE_UPDATE_SERIE = 'UpdateSerie';
    const CREATE_AUDIT_EVENT_TYPE_SERIE_ACTIVATE = 'SerieActivate';
    const CREATE_AUDIT_EVENT_TYPE_SERIE_INACTIVATE = 'SerieInactivate';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_COMPANY_PDF_TEMPLATE = 'CreateCompanyPdfTemplate';
    const CREATE_AUDIT_EVENT_TYPE_ACTIVATE_TEMPLATE = 'ActivateTemplate';
    const CREATE_AUDIT_EVENT_TYPE_INACTIVATE_TEMPLATE = 'InactivateTemplate';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_VIRTUAL_OPERATOR_PDF_TEMPLATE = 'CreateVirtualOperatorPdfTemplate';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_SYSTEM_PDF_TEMPLATE = 'CreateSystemPdfTemplate';
    const CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_DRAFT = 'CreateDocumentDraft';
    const CREATE_AUDIT_EVENT_TYPE_UPDATE_DOCUMENT_DRAFT = 'UpdateDocumentDraft';
    const CREATE_AUDIT_EVENT_TYPE_DELETE_DOCUMENT_DRAFT = 'DeleteDocumentDraft';
    const CREATE_AUDIT_EVENT_TYPE_DOCUMENT_STATUS_UPDATED = 'DocumentStatusUpdated';
     ...
     * @return string[]
     */
    public function getCreateAuditEventTypeAllowableValues()
    {
        return [
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_SALES_INVOICE,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_CREDIT_NOTE,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_DEBIT_NOTE,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_ASYNC,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_ASYNC_GENERATE_UBL_DOCUMENT,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_ASYNC_SEND_TO_AUTHORIZED_PROVIDER,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_SERIE,
            self::CREATE_AUDIT_EVENT_TYPE_UPDATE_SERIE,
            self::CREATE_AUDIT_EVENT_TYPE_SERIE_ACTIVATE,
            self::CREATE_AUDIT_EVENT_TYPE_SERIE_INACTIVATE,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_COMPANY_PDF_TEMPLATE,
            self::CREATE_AUDIT_EVENT_TYPE_ACTIVATE_TEMPLATE,
            self::CREATE_AUDIT_EVENT_TYPE_INACTIVATE_TEMPLATE,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_VIRTUAL_OPERATOR_PDF_TEMPLATE,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_SYSTEM_PDF_TEMPLATE,
            self::CREATE_AUDIT_EVENT_TYPE_CREATE_DOCUMENT_DRAFT,
            self::CREATE_AUDIT_EVENT_TYPE_UPDATE_DOCUMENT_DRAFT,
            self::CREATE_AUDIT_EVENT_TYPE_DELETE_DOCUMENT_DRAFT,
            self::CREATE_AUDIT_EVENT_TYPE_DOCUMENT_STATUS_UPDATED,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['create_audit_event_type'] = isset($data['create_audit_event_type']) ? $data['create_audit_event_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCreateAuditEventTypeAllowableValues();
        if (!is_null($this->container['create_audit_event_type']) && !in_array($this->container['create_audit_event_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'create_audit_event_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if ($this->container['reason_debit'] === null) {
            $invalidProperties[] = "'reason_debit' can't be null";
        }
    ...
    /**
     * Gets create_audit_event_type
     *
     * @return string
     */
    public function getCreateAuditEventType()
    {
        return $this->container['create_audit_event_type'];
    }

    /**
     * Sets create_audit_event_type
     *
     * @param string $create_audit_event_type create_audit_event_type
     *
     * @return $this
     */
    public function setCreateAuditEventType($create_audit_event_type)
    {
        $allowedValues = $this->getCreateAuditEventTypeAllowableValues();
        if (!is_null($create_audit_event_type) && !in_array($create_audit_event_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'create_audit_event_type', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['create_audit_event_type'] = $create_audit_event_type;
     ...
     * Sets reason_debit
     *
     * @param string $reason_debit reason_debit
     *
     * @return $this
     */
    ...
    public function setExternalReference($external_reference)
    {
        if (!is_null($external_reference) && (mb_strlen($external_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $external_reference when calling DebitNoteInputDto., must be smaller than or equal to 50.');
        }
    ...
    public function setCorrelationDocumentId($correlation_document_id)
    {
        if ((mb_strlen($correlation_document_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $correlation_document_id when calling DebitNoteInputDto., must be smaller than or equal to 50.');
        }
