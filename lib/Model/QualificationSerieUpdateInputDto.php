...
/**
 * QualificationSerieUpdateInputDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QualificationSerieUpdateInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QualificationSerieUpdateInputDto';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling QualificationSerieUpdateInputDto., must be smaller than or equal to 50.');
        }
    ...
    public function setPrefix($prefix)
    {
        if (!is_null($prefix) && (mb_strlen($prefix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling QualificationSerieUpdateInputDto., must be smaller than or equal to 4.');
        }
