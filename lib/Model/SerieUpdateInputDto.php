...
/**
 * SerieUpdateInputDto Class Doc Comment
 *
 * @category Class
 * @package  TM\Saphety\Clientv2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SerieUpdateInputDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SerieUpdateInputDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['auto_increment'] === null) {
            $invalidProperties[] = "'auto_increment' can't be null";
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SerieUpdateInputDto., must be smaller than or equal to 50.');
        }
    ...
    public function setPrefix($prefix)
    {
        if (!is_null($prefix) && (mb_strlen($prefix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling SerieUpdateInputDto., must be smaller than or equal to 4.');
        }
